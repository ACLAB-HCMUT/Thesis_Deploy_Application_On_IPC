...
class SignUpView(Frame):
    def __init__(self, *args, **kwargs):
        ...
        # Fullname input
        self.fullname_label = ctk.CTkLabel(self.login_frame,text="  Full name:", text_color="#601E88", anchor="w", justify="left", font=("Arial Bold", 14), image=self.email_icon, compound="left").pack(anchor="w", pady=(15, 0), padx=(25, 0))
        ...
        # Phone number input
        self.phone_label = ctk.CTkLabel(self.login_frame, text="  Phone number:", text_color="#601E88", anchor="w", justify="left", font=("Arial Bold", 14), image=self.email_icon, compound="left").pack(anchor="w", padx=(25, 0))
        ...
        # Address input
        self.address_label = ctk.CTkLabel(self.login_frame, text="  Address:", text_color="#601E88", anchor="w", justify="left", font=("Arial Bold", 14), image=self.email_icon, compound="left").pack(anchor="w", padx=(25, 0))
