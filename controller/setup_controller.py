...
from services.setup_services import  service_create_setup_scheduler, service_get_setup_scheduler, service_get_setup_scheduler_ByID, service_update_setup_scheduler, service_delete_setup_scheduler, service_delete_setup_threshold, service_put_setup_threshold, service_get_setup_threshold
...
def controller_delete_setup_threshold():
# Xác thực token
    try:
        # Truy vấn tất cả các document trong collection
        # verify_jwt_token(token)
