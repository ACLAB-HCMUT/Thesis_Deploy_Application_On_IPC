...
from controller.setup_controller import controller_create_setup_scheduler, controller_get_setup_scheduler, controller_get_setup_scheduler_ByID, controller_update_scheduler, controller_delete_scheduler, controller_put_setup_threshold, controller_delete_setup_scheduler, controller_get_setup_threshold, controller_delete_setup_threshold    
...
async def delete_setup_threshold():
    return controller_delete_setup_threshold()


@router.get("/threshold")
async def get_setup_threshold():
    return controller_get_setup_threshold()