...
import { House, TabletSmartphone, Bell, ShieldCheck, Monitor, Settings } from "lucide-react";
  ...
  return (
    <main className="flex min-h-screen bg-gray-50">
      ...
      <Sidebar>
          ...
          <SidebarItem icon={<Settings size={20} />} text="Settings" alert={false} active={true} to="settings" />
