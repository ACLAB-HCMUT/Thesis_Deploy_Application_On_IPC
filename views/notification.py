...
class NotificationView(ctk.CTkFrame):
    def __init__(self, *args, **kwargs):
        ...
        self.temperature_img_data = Image.open(os.path.join(base_path, "assets", "img", "logistics_icon.png"))
        ...
        self.humidity_img_data = Image.open(os.path.join(base_path, "assets", "img", "shipping_icon.png"))
        ...
        self.light_img_data = Image.open(os.path.join(base_path, "assets", "img", "delivered_icon.png"))
